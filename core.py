...
class ImageAcquirer:
    ...
    def start(self, *, run_as_thread: bool = False) -> None:
        ...
        if not self.is_acquiring():
            self._num_images_to_acquire = 0
        print("check 1")
        print(self._num_images_to_acquire)
        ...
        if self._num_images_to_acquire == 0:
            ...
            time.sleep(1)
            print("acq_mode: ", self.remote_device.node_map.AcquisitionMode.value)
            try:
        ...
        if not self.is_armed():
            ...
            for ds in self._data_streams:
                if ds.defines_payload_size():
                   ...
                   #     print("payload size: ", self.remote_device.node_map.PayloadSize.value)
